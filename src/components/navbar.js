      ...
      return (
        <div style={{ marginBottom: "70px", marginTop: "-15px" }}>
          <Navbar className="mdb-color darken-3" light expand="md" fixed="top">
            <NavbarBrand
              className="ml-2"
              style={{ fontFamily: "Viga", fontSize: "30px" }}
            >
              <Link to="/">
                <img
                  src="http://localhost:2000/upload/LogoNavbar.png"
                  alt="brand"
                  width="40px"
                />
                GamersLab
            ...
            <Collapse isOpen={this.state.isOpen} navbar>
              <Nav className="ml-auto" navbar>
                <NavItem>
                  <div className="input-group mt-1" style={{ width: "350px" }}>
                    <input
                      ...
                      onChange={() =>
                        this.setState({
                          searchData: this.refs.searchBook.value
                        })
                      }
                    ...
                    >
                      <Link to={"/search?q=" + this.state.searchData}>
                        <button
                          className="btn blue-gradient mb-1"
                          type="button"
                          id="button-addon2"
                          style={{ height: "35px" }}
                ...
                <NavItem>
                  <Link to="/register">
                    <NavLink
                      className="btn blue-gradient rounded-pill text-light mr-1 btn-sm"
                      style={{ fontSize: "12px" }}
                    >
                ...
                <NavItem>
                  <Link to="/login">
                    <NavLink
                      className="btn blue-gradient rounded-pill text-light btn-sm"
                      style={{ fontSize: "12px" }}
                    >
              ...
              <Nav className="ml-auto" navbar>
                <NavItem>
                  <div className="input-group mt-2" style={{ width: "350px" }}>
                    ...
                    />
                    <div
                      className="input-group-append mr-2"
                      style={{ marginTop: "-6px", height: "42px" }}
                    >
                  ...
                  <DropdownMenu right>
                    ...
                    {this.props.role === "admin" ? (
                      <Link to="/annualreport">
                        <DropdownItem>Annual Report</DropdownItem>
                      </Link>
                    ) : null}
                    <Link to="/">
                ...
                <NavItem>
                  <Link to="/cart">
                    ...
                    >
                      ...
                      {this.props.cart ? this.props.cart : null}{" "}
                    </NavLink>
                  </Link>
                </NavItem>
                <NavItem>
                  <Link to="/wishlist">
                    <NavLink className="wishlist" style={{ color: "white" }}>

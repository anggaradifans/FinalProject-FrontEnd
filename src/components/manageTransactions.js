        ...
        <tr>
          ...
          <td>
            <input
              ...
              value="Receipt"
              onClick={() =>
                this.setState({ receipt: val.bukti_transaksi, modal: true })
              }
            />
          </td>
          <td>
            <input
              ...
              value="Approve"
              onClick={() => this.approveTransaction(val)}
            />
            <input
              type="button"
              className="btn btn-primary"
              value="Reject"
              onClick={() => this.rejectTransaction(val)}
              style={{ width: "115px" }}
            />
          </td>
        </tr>
          ...
          <div>
            ...
            >
              ...
              <ModalBody>
                {this.state.receipt ? (
                  <img
                    src={"http://localhost:2000/" + this.state.receipt}
                    width="100%"
                    alt="broken"
                  />
                ) : (
...
export default connect(mapStateToProps, { hitungTransactions })(
  ManageTrasactions
);
